...
src/App.jsx & Main React component with factorial, fibonacci, and prime number checking logic \\ \hline
...
React Hooks (useState) & Managing state for input numbers and calculation results & App.jsx \\ \hline
Recursive Functions & Calculating factorial using recursion & App.jsx \\ \hline
Loop Iterations & Generating Fibonacci series & App.jsx \\ \hline
Prime Number Algorithm & Checking divisibility for prime detection & App.jsx \\ \hline
Conditional Rendering & Displaying results based on operation selected & App.jsx \\ \hline
...
\hline
\textbf{FileName} & \textbf{Purpose} \\ \hline
src/App.jsx & Main component with digit sum calculation logic and UI \\ \hline
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.8\textwidth]{example-image-b}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.9\textwidth]{example-image-c}}
...
\subsection{AIM}
To implement a Calculator Program using ReactJS that performs basic arithmetic operations (Addition, Subtraction, Multiplication, Division) with an interactive and user-friendly interface.
...
\hline
\textbf{FileName} & \textbf{Purpose} \\ \hline
src/App.jsx & Main component with calculator logic and operations handling \\ \hline
src/App.css & Modern calculator styling with button grid and display screen \\ \hline
...
\hline
\textbf{Concept Name} & \textbf{General Purpose} & \textbf{Code File} \\ \hline
React useState Hook & Managing calculator display and operation state & App.jsx \\ \hline
Event Handlers & Handling button clicks for numbers and operations & App.jsx \\ \hline
Arithmetic Operations & Performing +, -, ×, ÷ calculations & App.jsx \\ \hline
eval() or Custom Parser & Evaluating mathematical expressions & App.jsx \\ \hline
Conditional Rendering & Displaying results and handling errors & App.jsx \\ \hline
CSS Grid Layout & Creating calculator button layout & App.css \\ \hline
...
\subsection{ALGORITHM}
\begin{enumerate}
    \item Initialize state variables for display value and current operation
    ...
    \begin{itemize}
        ...
        \item Clear display for next input
    \end{itemize}
    \item When equals button clicked:
    \begin{itemize}
        \item Retrieve stored value and operation
        \item Perform calculation based on operation
        \item Display result
    \end{itemize}
...
\subsection{CODE EXPLANATION}
The calculator application uses React hooks to manage the display state and current operation. The UI consists of a grid of buttons including digits 0-9, operation buttons (+, -, ×, ÷), equals (=), and clear (C). When a number is clicked, it's appended to the display. Operation buttons store the current value and operation type. The equals button retrieves the stored values and performs the calculation. The implementation includes error handling for division by zero and invalid operations. The calculator supports chained operations and decimal numbers.

\subsection{OUTPUT}
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.8\textwidth]{example-image}}
...
\hline
\textbf{FileName} & \textbf{Purpose} \\ \hline
src/App.jsx & Main game component with math problems, game logic, and calculator features \\ \hline
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.9\textwidth]{example-image-a}}
    \caption{Space Math Adventure - Main Menu}
\end{figure}

\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.9\textwidth]{example-image-b}}
...
\begin{itemize}
    \item \textbf{Fundamental Concepts:} State management, event handling, component lifecycle
    \item \textbf{Mathematical Operations:} Armstrong numbers, natural numbers, comparisons
    \item \textbf{Business Logic:} Salary calculations, tax computations, bonus determination
    \item \textbf{Game Development:} Interactive gameplay, animation, collision detection
    \item \textbf{UI/UX Design:} Responsive layouts, modern styling, user interactions
    \item \textbf{Best Practices:} Code organization, component reusability, performance optimization
\end{itemize}
